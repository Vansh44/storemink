...
>
> **Current prompt versions:** `read-beta-v15` and `draft-action-beta-v31`
>
...
| ----------------- | ----------------------- | --------------------- |
| Read-only beta    | `read-beta-v15`         | `read-beta-v11`       |
| Draft/action beta | `draft-action-beta-v31` | `draft-beta-v21`      |
