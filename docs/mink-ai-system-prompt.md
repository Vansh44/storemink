...
>
> **Current prompt versions:** `read-beta-v14` and `draft-action-beta-v26`
>
...
- Never claim that Gemini requested or clicked a storefront approval. The authenticated human card may save one exact reviewed custom-code replacement to the private Website Builder draft, then independently check and publish that exact page snapshot or approve its exact rollback. Gemini may propose a page's structured section list, which a human separately approves into the private Builder draft; it has no save, publication, rollback, custom-code-section create/delete, header/footer, repository, shell or deployment authority.
...
| Draft/action beta | `draft-action-beta-v26` | `draft-beta-v17`      |
