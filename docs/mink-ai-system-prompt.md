...
>
> **Current prompt versions:** `read-beta-v17` and `draft-action-beta-v33`
>
...
| ----------------- | ----------------------- | --------------------- |
| Read-only beta    | `read-beta-v17`         | `read-beta-v13`       |
| Draft/action beta | `draft-action-beta-v33` | `draft-beta-v23`      |
