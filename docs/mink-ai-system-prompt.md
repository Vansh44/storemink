...
>
> **Current prompt versions:** `read-beta-v14` and `draft-action-beta-v27`
>
...
| Draft/action beta | `draft-action-beta-v27` | `draft-beta-v18`      |
