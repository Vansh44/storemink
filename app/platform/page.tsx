...
const PLANS = [
  {
    ...
    features: [
      ...
      `${PLAN_LIMITS.free.aiGenerationsPerMonth} Mink credits a month`,
    ],
    cta: "Start free",
    popular: false,
  },
  {
    ...
    features: [
      ...
      `${PLAN_LIMITS.basic.aiGenerationsPerMonth} Mink credits a month`,
    ],
  ...
  },
  {
    ...
    features: [
      ...
      `${PLAN_LIMITS.pro.aiGenerationsPerMonth} Mink credits a month`,
    ],
